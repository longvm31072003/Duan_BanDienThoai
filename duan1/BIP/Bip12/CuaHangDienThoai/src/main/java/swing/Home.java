...
// hết code
    ...
    void checkKM(String tenKhuyenMai) {
...
//Hết fill Hoa
    ...
    public void fillToHoaDon(List<HoaDon> list) {
    ...
    public static void fillToHoaDonIn() {
        DefaultTableModel modelHoaDon1 = (DefaultTableModel) tblHoaDon.getModel();
        modelHoaDon1.setRowCount(0);
        for (HoaDon x : HoaDonRepository.getAll1()) {
            modelHoaDon1.addRow(new Object[]{x.getMaHD(), x.getNhanVien().getMa(), x.getNgayTao(), x.getThanhToan(), x.getTrangThaiStr()});
        }
    }
...
//        HoaDon hoaDon = HoaDonRepository.getDienThoai(maHD);
//        List<HoaDonChiTiet> list = hoaDon.getList();
    ...
    private void initComponents() {
        ...
        cbbRam.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)));

        cbbRom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbbRom.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)));

        cbbMauSac.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbbMauSac.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 153)));
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbbRom, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cbbRam, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(29, 29, 29)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel72)
                                    .addComponent(jLabel77, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cbbMauSac, 0, 130, Short.MAX_VALUE)
                                    .addComponent(txtHeDieuHanhDT))
                                .addGap(28, 28, 28)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel12Layout.createSequentialGroup()
                    .addGap(25, 25, 25)
                    .addComponent(panelLineChart, javax.swing.GroupLayout.PREFERRED_SIZE, 1324, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel12Layout.createSequentialGroup()
                    .addGap(154, 154, 154)
                    .addComponent(panelLineChart, javax.swing.GroupLayout.PREFERRED_SIZE, 412, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel35Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel35Layout.createSequentialGroup()
                ...
                .addGroup(jPanel35Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbftrangthaihoadon, 0, 248, Short.MAX_VALUE)
                    .addComponent(cbfsanpham, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        pnlHoaDonLayout.setHorizontalGroup(
            ...
            .addGroup(pnlHoaDonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlHoaDonLayout.createSequentialGroup()
                    .addGap(4, 4, 4)
                    .addComponent(jScrollPane27, javax.swing.GroupLayout.DEFAULT_SIZE, 1372, Short.MAX_VALUE)
                    .addGap(4, 4, 4)))
        );
        pnlHoaDonLayout.setVerticalGroup(
            ...
            .addGroup(pnlHoaDonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlHoaDonLayout.createSequentialGroup()
                    .addGap(252, 252, 252)
                    .addComponent(jScrollPane27, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel48Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel48Layout.createSequentialGroup()
                ...
                .addGroup(jPanel48Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnImportPK, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        thongKeCot();
    ...
    private void btnHuyHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyHoaDonActionPerformed
        ...
        int row = tblHoaDon.getSelectedRow();
        //        HoaDon hd = hoaDonRepo.getDienThoai(maHD);
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        Long l = Long.parseLong(txtTienKhachDua.getText().trim());
        Long l1 = Long.parseLong(txtTienTraKhach.getText().trim());
//        if (l1>l) {
...
//        }
        ...
        if (hdct.isEmpty()) {
            ...
            if (chkDiemTichLuy.isSelected()) {
                diemTichLuy = txtDiemTichLuy.getText();
            }
            new In(hd, hdct, diemTichLuy, txtTongTien.getText(), l.toString(), l1.toString()).setVisible(true);
//            String diemTichLuy = "0";
//            if (chkDiemTichLuy.isSelected()) {
//                diemTichLuy = txtDiemTichLuy.getText();
...
//            JOptionPane.showMessageDialog(this, "Thanh toán thành công");
    ...
    private void txtTienKhachDuaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTienKhachDuaKeyPressed
        ...
        Long tongTien =Long.valueOf(tongTienStr);
...
//                txtText.setText(excelFile.toString());
                ...
                for (int row = 0; row <= excelSheet.getLastRowNum(); row++) {
                    ...
                    if (listPkChua == null) {
                        if (dienThoaiService.getOne(String.valueOf(maSp)) == null) {
                            XSSFCell ten = excelRow.getCell(5);
                            XSSFCell cpu = excelRow.getCell(7);
                            XSSFCell manHinh = excelRow.getCell(8);
                            XSSFCell pin = excelRow.getCell(9);
                            XSSFCell camera = excelRow.getCell(10);
                            XSSFCell heDieuHanh = excelRow.getCell(11);
                            XSSFCell anh = excelRow.getCell(12);
                            XSSFCell thoiGianBaoHanh = excelRow.getCell(13);
                            XSSFCell moTa = excelRow.getCell(14);
                            XSSFCell TrangThai = excelRow.getCell(15);
                            XSSFCell tenHang = excelRow.getCell(16);
                            XSSFCell mauSac = excelRow.getCell(17);
                            XSSFCell ram = excelRow.getCell(18);
                            XSSFCell rom = excelRow.getCell(19);
                            ...
                            QLDienThoai newDt = new QLDienThoai(null, maSp.toString(), ten.toString(), 0, cpu.toString(),
                                    ...
                                    Integer.valueOf(thoiGianBaoHanh.getRawValue()), moTa.toString(), Integer.valueOf(TrangThai.getRawValue()), hang, null, null, null);
                            ...
                            QLDTNhaCungCap newDtNcc = new QLDTNhaCungCap(null, ncc.getId(), dt.getIdDienThoai(),
                                    ncc.getMa(), newDt.getMaDienThoai(), convertGiaTien,
                                    Integer.valueOf(soLuongNhap.getRawValue()), new java.util.Date());
                            listDtChua.add(newDtNcc);
                        } else {
                            QLDienThoai dt = dienThoaiService.getOne(String.valueOf(maSp));
                            QLNhaCungCap ncc = nccService.getOne(String.valueOf(maNcc));
                            QLDTNhaCungCap newDtNcc = new QLDTNhaCungCap(null, ncc.getId(), dt.getIdDienThoai(),
                        ...
                        if (phuKienService.getOne(String.valueOf(maSp)) == null) {
                            XSSFCell ten = excelRow.getCell(5);
                            XSSFCell anh = excelRow.getCell(8);
                            XSSFCell thoiGianBaoHanh = excelRow.getCell(9);
                            XSSFCell moTa = excelRow.getCell(10);
                            XSSFCell TrangThai = excelRow.getCell(11);
                            XSSFCell tenHang = excelRow.getCell(12);
                            ImageIcon icon = new ImageIcon(anh.toString());
                            personalImage = ImageHelper.toByteArray(icon.getImage(), "jpg");
                            Hang hang = iHangService.getOne(tenHang.getStringCellValue());
                            QLNhaCungCap ncc = nccService.getOne(String.valueOf(maNcc));
                            QLPhuKien newPk = new QLPhuKien(null, maSp.toString(), ten.toString(), 0, new BigDecimal(0.0), personalImage, Integer.valueOf(thoiGianBaoHanh.toString()), moTa.toString(), Integer.valueOf(TrangThai.toString()), hang);
                            QLPhuKienNCC newPkNcc = new QLPhuKienNCC(null, ncc.getId(), newPk.getId(),
                                    ncc.getMa(), newPk.getMa(), convertGiaTien,
                                    Integer.valueOf(soLuongNhap.getRawValue()), new java.util.Date());
                            listPkChua.add(newPkNcc);
                        } else {
                            QLPhuKien pk = phuKienService.getOne(String.valueOf(maSp));
                            QLNhaCungCap ncc = nccService.getOne(String.valueOf(maNcc));
                            QLPhuKienNCC newPkNcc = new QLPhuKienNCC(null, ncc.getId(), pk.getId(),
                    ...
                    model.addRow(new Object[]{maSp, maNcc, soLuongNhap, giaTien, new java.util.Date()});
                }
    ...
    public void showDataTableChuaPk(List<QLPhuKienNCC> list) {
        ...
        for (QLPhuKienNCC x : list) {
            dtmPhuKienNcc.addRow(new Object[]{x.getMaphuKien(), x.getManhaCungCap(), x.getSoLuongNhap(), x.getGiaNhap()});
        }
    }
