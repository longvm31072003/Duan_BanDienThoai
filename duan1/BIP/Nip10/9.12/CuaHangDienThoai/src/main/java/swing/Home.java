...
//        List<HoaDonChiTiet> list = hoaDon.getList();
    ...
    private void initComponents() {
        ...
        jTextField100.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(71, 120, 197)));
        ...
        jPanel25Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel25Layout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addComponent(jTextField100, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(cboLocSanPham, javax.swing.GroupLayout.PREFERRED_SIZE, 203, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(59, 59, 59))
            .addComponent(scpSanPhamBH, javax.swing.GroupLayout.DEFAULT_SIZE, 844, Short.MAX_VALUE)
        );
...
//                ViewQuetImae viewQuetImae = new ViewQuetImae(this, true, listChuaDTNCC, null, DtNcc, null, listIMeiVao);
    ...
    private void btnNhapPKNCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapPKNCCActionPerformed
        ...
        for (QLImei qLImei : listIMeiVao) {
            JOptionPane.showMessageDialog(this, iimeiService.save(qLImei));
...
//                    lbDan.setIcon(icon);
    ...
    public void showDataTableChuaPk(List<QLPhuKienNCC> list) {
        ...
        for (QLPhuKienNCC x : list) {
            dtmPhuKienNcc.addRow(new Object[]{x.getMaphuKien(), x.getManhaCungCap(), x.getSoLuongNhap(), x.getGiaNhap(), x.getNgayNhap(), x.getTrangThai() == 0 ? "Chưa có imei" : "Đã có imei"});
        }
    }
...
//        txtSdtNcc.setText(selectNcc.getSdt());
//    }
    private void showDataTableImeiPK() {
